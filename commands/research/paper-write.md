...
### Trigger Conditions
- Command syntax: /research:paper-write [args]
...
[commit|confident] <promise>RESEARCH:PAPER_WRITE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]