...
### Trigger Conditions
- Command syntax: /init-model-card [args]
...
[commit|confident] <promise>INIT_MODEL_CARD_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]