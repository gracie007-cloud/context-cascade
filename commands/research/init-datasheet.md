...
### Trigger Conditions
- Command syntax: /init-datasheet [args]
...
[commit|confident] <promise>INIT_DATASHEET_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]