...
### Trigger Conditions
- Command syntax: /research:citation-manager [args]
...
### Example Invocation
- /research:citation-manager example
...
[commit|confident] <promise>RESEARCH:CITATION_MANAGER_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]