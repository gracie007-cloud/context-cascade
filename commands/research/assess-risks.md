...
### Trigger Conditions
- Command syntax: /assess-risks [args]
...
[commit|confident] <promise>ASSESS_RISKS_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]