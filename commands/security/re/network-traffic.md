...
### Trigger Conditions
- Command syntax: /network-traffic [args]
...
[commit|confident] <promise>NETWORK_TRAFFIC_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]