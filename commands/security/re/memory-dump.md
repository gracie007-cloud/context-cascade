...
### Trigger Conditions
- Command syntax: /memory-dump [args]
...
[commit|confident] <promise>MEMORY_DUMP_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]