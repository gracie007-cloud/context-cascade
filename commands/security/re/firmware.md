...
### Purpose
- Primary action: Path to firmware image/binary

### Trigger Conditions
- Command syntax: /re:firmware [args]
...
[commit|confident] <promise>RE:FIRMWARE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]