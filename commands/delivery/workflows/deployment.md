...
### Trigger Conditions
- Command syntax: /deployment [args]
...
[commit|confident] <promise>DEPLOYMENT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]