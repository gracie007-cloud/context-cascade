...
### Trigger Conditions
- Command syntax: /workflow-export [args]
...
[commit|confident] <promise>WORKFLOW_EXPORT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]