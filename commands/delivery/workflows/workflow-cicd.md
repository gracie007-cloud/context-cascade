...
### Trigger Conditions
- Command syntax: /workflow-cicd [args]
...
[commit|confident] <promise>WORKFLOW_CICD_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]