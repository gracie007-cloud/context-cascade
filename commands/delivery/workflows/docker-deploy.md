...
### Purpose
- Primary action: Docker image tag to deploy

### Trigger Conditions
- Command syntax: /docker-deploy [args]
...
[commit|confident] <promise>DOCKER_DEPLOY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]