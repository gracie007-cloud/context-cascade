...
### Trigger Conditions
- Command syntax: /workflow-create [args]
...
[commit|confident] <promise>WORKFLOW_CREATE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]