...
binding: skill:workflow-rollback
category: delivery
---
...
### Trigger Conditions
- Command syntax: /workflow-rollback [args]
...
[commit|confident] <promise>WORKFLOW_ROLLBACK_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]