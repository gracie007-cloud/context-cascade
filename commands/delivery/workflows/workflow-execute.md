...
binding: skill:workflow-execute
category: delivery
---
...
### Trigger Conditions
- Command syntax: /workflow-execute [args]
...
[commit|confident] <promise>WORKFLOW_EXECUTE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]