...
### Trigger Conditions
- Command syntax: /specialization [args]
...
[commit|confident] <promise>SPECIALIZATION_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]