...
### Trigger Conditions
- Command syntax: /model-update [args]
...
[commit|confident] <promise>MODEL_UPDATE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]