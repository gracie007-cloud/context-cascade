...
### Trigger Conditions
- Command syntax: /pattern-learn [args]
...
[commit|confident] <promise>PATTERN_LEARN_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]