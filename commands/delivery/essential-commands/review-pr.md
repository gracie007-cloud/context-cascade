...
### Purpose
- Primary action: PR number to review

### Trigger Conditions
- Command syntax: /review-pr [args]
...
[commit|confident] <promise>REVIEW_PR_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]