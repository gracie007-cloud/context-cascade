...
binding: skill:integration-test
category: delivery
---
...
### Trigger Conditions
- Command syntax: /integration-test [args]
...
[commit|confident] <promise>INTEGRATION_TEST_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]