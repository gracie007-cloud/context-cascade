...
### Purpose
- Primary action: File or directory to check

### Trigger Conditions
- Command syntax: /quick-check [args]
...
[commit|confident] <promise>QUICK_CHECK_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]