...
### Purpose
- Primary action: Workflow goal description

### Trigger Conditions
- Command syntax: /create-cascade [args]
...
[commit|confident] <promise>CREATE_CASCADE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]