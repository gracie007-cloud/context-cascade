...
### Trigger Conditions
- Command syntax: /sparc-security-review [args]
...
[commit|confident] <promise>SPARC_SECURITY_REVIEW_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]