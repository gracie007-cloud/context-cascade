...
### Trigger Conditions
- Command syntax: /sparc-spec-pseudocode [args]
...
[commit|confident] <promise>SPARC_SPEC_PSEUDOCODE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]