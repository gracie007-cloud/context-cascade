...
### Trigger Conditions
- Command syntax: /sparc-debug [args]
...
[commit|confident] <promise>SPARC_DEBUG_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]