...
### Trigger Conditions
- Command syntax: /sparc-refinement-optimization-mode [args]
...
### Example Invocation
- /sparc-refinement-optimization-mode example
...
[commit|confident] <promise>SPARC_REFINEMENT_OPTIMIZATION_MODE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]