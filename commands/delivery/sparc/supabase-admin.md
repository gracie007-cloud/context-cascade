...
### Trigger Conditions
- Command syntax: /sparc-supabase-admin [args]
...
[commit|confident] <promise>SPARC_SUPABASE_ADMIN_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]