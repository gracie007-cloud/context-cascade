...
### Trigger Conditions
- Command syntax: /sparc:database-architect [args]
...
### Example Invocation
- /sparc:database-architect example
...
[commit|confident] <promise>SPARC:DATABASE_ARCHITECT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]