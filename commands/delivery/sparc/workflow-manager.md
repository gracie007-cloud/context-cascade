...
binding: skill:workflow-manager
category: delivery
---
...
### Trigger Conditions
- Command syntax: /workflow-manager [args]
...
[commit|confident] <promise>WORKFLOW_MANAGER_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]