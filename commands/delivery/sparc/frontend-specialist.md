...
### Trigger Conditions
- Command syntax: /sparc:frontend-specialist [args]
...
### Example Invocation
- /sparc:frontend-specialist example
...
[commit|confident] <promise>SPARC:FRONTEND_SPECIALIST_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]