...
### Trigger Conditions
- Command syntax: /sparc-code [args]
...
[commit|confident] <promise>SPARC_CODE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]