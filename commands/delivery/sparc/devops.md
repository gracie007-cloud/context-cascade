...
### Trigger Conditions
- Command syntax: /sparc-devops [args]
...
[commit|confident] <promise>SPARC_DEVOPS_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]