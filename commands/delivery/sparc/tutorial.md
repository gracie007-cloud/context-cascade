...
### Trigger Conditions
- Command syntax: /sparc-tutorial [args]
...
[commit|confident] <promise>SPARC_TUTORIAL_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]