...
x-version: 2.0.0
x-category: sparc-specialists
x-vcl-compliance: v3.1.1
binding: skill:sparc:backend-specialist
...
### Trigger Conditions
- Command syntax: /sparc:backend-specialist [args]
...
### Example Invocation
- /sparc:backend-specialist example
...
[commit|confident] <promise>SPARC:BACKEND_SPECIALIST_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]