...
binding: skill:sparc-integration
category: delivery
---
...
### Trigger Conditions
- Command syntax: /sparc-integration [args]
...
[commit|confident] <promise>SPARC_INTEGRATION_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]