...
binding: skill:swarm-coordinator
category: delivery
---
...
### Trigger Conditions
- Command syntax: /swarm-coordinator [args]
...
[commit|confident] <promise>SWARM_COORDINATOR_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]