...
binding: skill:sparc:mobile-specialist
...
### Trigger Conditions
- Command syntax: /sparc:mobile-specialist [args]
...
### Example Invocation
- /sparc:mobile-specialist example
...
[commit|confident] <promise>SPARC:MOBILE_SPECIALIST_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]