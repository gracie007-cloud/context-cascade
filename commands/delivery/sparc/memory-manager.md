...
### Trigger Conditions
- Command syntax: /memory-manager [args]
...
[commit|confident] <promise>MEMORY_MANAGER_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]