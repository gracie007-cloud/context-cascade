...
### Trigger Conditions
- Command syntax: /researcher [args]
...
[commit|confident] <promise>RESEARCHER_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]