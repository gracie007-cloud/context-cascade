...
### Trigger Conditions
- Command syntax: /batch-executor [args]
...
[commit|confident] <promise>BATCH_EXECUTOR_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]