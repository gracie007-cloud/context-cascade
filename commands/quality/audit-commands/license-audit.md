...
x-version: 2.0.0
x-category: audit-commands
x-vcl-compliance: v3.1.1
binding: skill:license-audit
...
### Trigger Conditions
- Command syntax: /license-audit [args]
...
[commit|confident] <promise>LICENSE_AUDIT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]