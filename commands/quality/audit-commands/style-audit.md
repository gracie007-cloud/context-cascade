...
binding: skill:micro-style-audit
category: audit
---
...
### Purpose
- Primary action: File or directory to audit

### Trigger Conditions
- Command syntax: /style-audit [args]
...
[commit|confident] <promise>STYLE_AUDIT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]