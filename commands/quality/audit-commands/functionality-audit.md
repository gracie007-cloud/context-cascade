...
### Purpose
- Primary action: File or directory to test

### Trigger Conditions
- Command syntax: /functionality-audit [args]
...
[commit|confident] <promise>FUNCTIONALITY_AUDIT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]