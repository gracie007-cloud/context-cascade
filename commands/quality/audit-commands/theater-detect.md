...
### Purpose
- Primary action: File or directory to scan

### Trigger Conditions
- Command syntax: /theater-detect [args]
...
[commit|confident] <promise>THEATER_DETECT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]