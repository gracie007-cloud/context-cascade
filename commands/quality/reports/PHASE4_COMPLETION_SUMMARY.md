...
### Trigger Conditions
- Command syntax: /PHASE4_COMPLETION_SUMMARY [args]
...
### Example Invocation
- /PHASE4_COMPLETION_SUMMARY example
...
[commit|confident] <promise>PHASE4_COMPLETION_SUMMARY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]