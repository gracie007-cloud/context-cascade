...
### Trigger Conditions
- Command syntax: /PHASE4_QUICK_REFERENCE [args]
...
### Example Invocation
- /PHASE4_QUICK_REFERENCE example
...
[commit|confident] <promise>PHASE4_QUICK_REFERENCE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]