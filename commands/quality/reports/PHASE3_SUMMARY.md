...
### Trigger Conditions
- Command syntax: /PHASE3_SUMMARY [args]
...
[commit|confident] <promise>PHASE3_SUMMARY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]