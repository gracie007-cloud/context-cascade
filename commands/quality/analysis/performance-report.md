...
binding: skill:performance-report
category: delivery
---
...
### Trigger Conditions
- Command syntax: /performance-report [args]
...
[commit|confident] <promise>PERFORMANCE_REPORT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]