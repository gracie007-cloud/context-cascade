...
### Trigger Conditions
- Command syntax: /bottleneck-detect [args]
...
[commit|confident] <promise>BOTTLENECK_DETECT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]