...
### Trigger Conditions
- Command syntax: /token-usage [args]
...
[commit|confident] <promise>TOKEN_USAGE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]