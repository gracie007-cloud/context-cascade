...
binding: skill:token-efficiency
category: delivery
---
...
### Trigger Conditions
- Command syntax: /token-efficiency [args]
...
[commit|confident] <promise>TOKEN_EFFICIENCY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]