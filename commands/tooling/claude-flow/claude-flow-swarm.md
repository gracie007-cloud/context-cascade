...
### Trigger Conditions
- Command syntax: /claude-flow-swarm [args]
...
[commit|confident] <promise>CLAUDE_FLOW_SWARM_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]