...
### Trigger Conditions
- Command syntax: /claude-flow-help [args]
...
[commit|confident] <promise>CLAUDE_FLOW_HELP_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]