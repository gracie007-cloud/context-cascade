...
### Trigger Conditions
- Command syntax: /claude-flow-memory [args]
...
[commit|confident] <promise>CLAUDE_FLOW_MEMORY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]