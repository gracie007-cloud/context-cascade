...
### Purpose
- Primary action: Implementation task description

### Trigger Conditions
- Command syntax: /codex-auto [args]
...
[commit|confident] <promise>CODEX_AUTO_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]