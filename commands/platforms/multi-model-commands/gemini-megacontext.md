...
### Purpose
- Primary action: Analysis task description

### Trigger Conditions
- Command syntax: /gemini-megacontext [args]
...
[commit|confident] <promise>GEMINI_MEGACONTEXT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]