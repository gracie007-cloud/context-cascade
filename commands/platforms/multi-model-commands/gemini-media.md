---
name: gemini-media
description: Gemini media command
allowed-tools:
- Read
- Write
- Edit
...
### Purpose
- Primary action: Gemini media command

### Trigger Conditions
- Command syntax: /gemini-media [args]
...
[commit|confident] <promise>GEMINI_MEDIA_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]