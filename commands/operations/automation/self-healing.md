...
### Trigger Conditions
- Command syntax: /self-healing [args]
...
[commit|confident] <promise>SELF_HEALING_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]