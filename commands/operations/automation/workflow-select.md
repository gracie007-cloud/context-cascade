...
### Trigger Conditions
- Command syntax: /workflow-select [args]
...
[commit|confident] <promise>WORKFLOW_SELECT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]