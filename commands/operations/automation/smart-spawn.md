...
### Trigger Conditions
- Command syntax: /smart-spawn [args]
...
[commit|confident] <promise>SMART_SPAWN_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]