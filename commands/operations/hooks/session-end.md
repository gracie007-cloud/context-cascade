...
### Trigger Conditions
- Command syntax: /session-end [args]
...
[commit|confident] <promise>SESSION_END_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]