...
### Trigger Conditions
- Command syntax: /hook:on-push [args]
...
[commit|confident] <promise>HOOK:ON_PUSH_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]