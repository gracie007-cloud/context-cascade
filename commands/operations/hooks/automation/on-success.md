...
### Trigger Conditions
- Command syntax: /hook:on-success [args]
...
[commit|confident] <promise>HOOK:ON_SUCCESS_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]