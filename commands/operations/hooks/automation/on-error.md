...
### Trigger Conditions
- Command syntax: /hook:on-error [args]
...
[commit|confident] <promise>HOOK:ON_ERROR_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]