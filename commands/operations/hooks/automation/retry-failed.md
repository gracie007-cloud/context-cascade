...
### Trigger Conditions
- Command syntax: /automation:retry-failed [args]
...
### Example Invocation
- /automation:retry-failed example
...
[commit|confident] <promise>AUTOMATION:RETRY_FAILED_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]