...
### Trigger Conditions
- Command syntax: /hook:on-deploy [args]
...
[commit|confident] <promise>HOOK:ON_DEPLOY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]