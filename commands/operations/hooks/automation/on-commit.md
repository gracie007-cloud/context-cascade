...
### Trigger Conditions
- Command syntax: /hook:on-commit [args]
...
[commit|confident] <promise>HOOK:ON_COMMIT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]