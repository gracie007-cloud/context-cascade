...
### Trigger Conditions
- Command syntax: /hook:on-pr [args]
...
[commit|confident] <promise>HOOK:ON_PR_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]