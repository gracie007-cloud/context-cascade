...
### Trigger Conditions
- Command syntax: /automation:schedule-task [args]
...
### Example Invocation
- /automation:schedule-task example
...
[commit|confident] <promise>AUTOMATION:SCHEDULE_TASK_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]