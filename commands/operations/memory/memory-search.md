...
### Trigger Conditions
- Command syntax: /memory-search [args]
...
[commit|confident] <promise>MEMORY_SEARCH_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]