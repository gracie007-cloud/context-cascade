...
### Trigger Conditions
- Command syntax: /memory-import [args]
...
[commit|confident] <promise>MEMORY_IMPORT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]