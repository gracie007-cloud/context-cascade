...
### Trigger Conditions
- Command syntax: /memory-stats [args]
...
[commit|confident] <promise>MEMORY_STATS_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]