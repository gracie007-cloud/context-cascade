...
### Trigger Conditions
- Command syntax: /memory-clear [args]
...
[commit|confident] <promise>MEMORY_CLEAR_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]