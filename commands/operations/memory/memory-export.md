...
### Trigger Conditions
- Command syntax: /memory-export [args]
...
[commit|confident] <promise>MEMORY_EXPORT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]