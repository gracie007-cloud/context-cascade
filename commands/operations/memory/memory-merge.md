...
### Trigger Conditions
- Command syntax: /memory-merge [args]
...
[commit|confident] <promise>MEMORY_MERGE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]