...
### Trigger Conditions
- Command syntax: /memory-usage [args]
...
[commit|confident] <promise>MEMORY_USAGE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]