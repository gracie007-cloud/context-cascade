...
binding: skill:topology-optimize
category: delivery
---
...
### Trigger Conditions
- Command syntax: /topology-optimize [args]
...
[commit|confident] <promise>TOPOLOGY_OPTIMIZE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]