...
### Trigger Conditions
- Command syntax: /cpu-optimize [args]
...
[commit|confident] <promise>CPU_OPTIMIZE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]