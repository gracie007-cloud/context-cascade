...
### Trigger Conditions
- Command syntax: /memory-optimize [args]
...
[commit|confident] <promise>MEMORY_OPTIMIZE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]