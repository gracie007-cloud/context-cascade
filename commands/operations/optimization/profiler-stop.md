...
### Trigger Conditions
- Command syntax: /profiler-stop [args]
...
[commit|confident] <promise>PROFILER_STOP_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]