...
binding: skill:resource-optimize
category: delivery
---
...
### Trigger Conditions
- Command syntax: /resource-optimize [args]
...
[commit|confident] <promise>RESOURCE_OPTIMIZE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]