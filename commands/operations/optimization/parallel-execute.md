...
binding: skill:parallel-execute
category: delivery
---
...
### Trigger Conditions
- Command syntax: /parallel-execute [args]
...
[commit|confident] <promise>PARALLEL_EXECUTE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]