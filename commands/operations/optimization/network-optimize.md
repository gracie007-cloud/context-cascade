...
binding: skill:network-optimize
category: delivery
---
...
### Trigger Conditions
- Command syntax: /network-optimize [args]
...
[commit|confident] <promise>NETWORK_OPTIMIZE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]