...
### Trigger Conditions
- Command syntax: /profiler-start [args]
...
[commit|confident] <promise>PROFILER_START_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]