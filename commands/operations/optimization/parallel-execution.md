...
binding: skill:parallel-execution
category: delivery
---
...
### Trigger Conditions
- Command syntax: /parallel-execution [args]
...
[commit|confident] <promise>PARALLEL_EXECUTION_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]