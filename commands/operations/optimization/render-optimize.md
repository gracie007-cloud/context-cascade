...
### Trigger Conditions
- Command syntax: /render-optimize [args]
...
[commit|confident] <promise>RENDER_OPTIMIZE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]