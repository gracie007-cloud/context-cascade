...
### Trigger Conditions
- Command syntax: /query-optimize [args]
...
[commit|confident] <promise>QUERY_OPTIMIZE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]