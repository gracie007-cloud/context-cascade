...
### Trigger Conditions
- Command syntax: /log-stream [args]
...
[commit|confident] <promise>LOG_STREAM_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]