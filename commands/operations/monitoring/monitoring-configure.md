...
### Trigger Conditions
- Command syntax: /monitoring-configure [args]
...
[commit|confident] <promise>MONITORING_CONFIGURE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]