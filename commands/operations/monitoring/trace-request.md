...
### Trigger Conditions
- Command syntax: /trace-request [args]
...
[commit|confident] <promise>TRACE_REQUEST_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]