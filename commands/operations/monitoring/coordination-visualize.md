...
### Trigger Conditions
- Command syntax: /coordination-visualize [args]
...
### Example Invocation
- /coordination-visualize example
...
[commit|confident] <promise>COORDINATION_VISUALIZE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]