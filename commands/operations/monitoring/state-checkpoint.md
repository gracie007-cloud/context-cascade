...
binding: skill:state-checkpoint
category: delivery
---
...
### Trigger Conditions
- Command syntax: /state-checkpoint [args]
...
[commit|confident] <promise>STATE_CHECKPOINT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]