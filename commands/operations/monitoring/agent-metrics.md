...
### Trigger Conditions
- Command syntax: /agent-metrics [args]
...
[commit|confident] <promise>AGENT_METRICS_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]