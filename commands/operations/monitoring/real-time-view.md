...
### Trigger Conditions
- Command syntax: /real-time-view [args]
...
[commit|confident] <promise>REAL_TIME_VIEW_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]