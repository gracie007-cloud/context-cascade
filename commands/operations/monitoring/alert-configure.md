...
### Trigger Conditions
- Command syntax: /alert-configure [args]
...
[commit|confident] <promise>ALERT_CONFIGURE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]