...
### Trigger Conditions
- Command syntax: /state-diff [args]
...
[commit|confident] <promise>STATE_DIFF_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]