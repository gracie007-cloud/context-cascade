...
### Trigger Conditions
- Command syntax: /swarm-monitor [args]
...
[commit|confident] <promise>SWARM_MONITOR_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]