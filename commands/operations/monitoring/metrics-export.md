...
### Trigger Conditions
- Command syntax: /metrics-export [args]
...
[commit|confident] <promise>METRICS_EXPORT_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]