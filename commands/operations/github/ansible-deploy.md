...
### Trigger Conditions
- Command syntax: /ansible-deploy [args]
...
[commit|confident] <promise>ANSIBLE_DEPLOY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]