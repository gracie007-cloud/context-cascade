...
### Trigger Conditions
- Command syntax: /issue-triage [args]
...
[commit|confident] <promise>ISSUE_TRIAGE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]