...
### Trigger Conditions
- Command syntax: /code-review [args]
...
[commit|confident] <promise>CODE_REVIEW_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]