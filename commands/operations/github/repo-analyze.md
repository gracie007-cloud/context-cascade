...
### Trigger Conditions
- Command syntax: /repo-analyze [args]
...
[commit|confident] <promise>REPO_ANALYZE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]