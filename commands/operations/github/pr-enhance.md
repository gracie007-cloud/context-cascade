...
### Trigger Conditions
- Command syntax: /pr-enhance [args]
...
[commit|confident] <promise>PR_ENHANCE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]