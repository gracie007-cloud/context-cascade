...
### Trigger Conditions
- Command syntax: /terraform-apply [args]
...
[commit|confident] <promise>TERRAFORM_APPLY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]