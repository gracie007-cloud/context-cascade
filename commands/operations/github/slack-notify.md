...
### Trigger Conditions
- Command syntax: /slack-notify [args]
...
[commit|confident] <promise>SLACK_NOTIFY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]