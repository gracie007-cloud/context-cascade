...
### Trigger Conditions
- Command syntax: /aws-deploy [args]
...
[commit|confident] <promise>AWS_DEPLOY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]