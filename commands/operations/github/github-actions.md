...
### Trigger Conditions
- Command syntax: /github-actions [args]
...
[commit|confident] <promise>GITHUB_ACTIONS_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]