...
### Trigger Conditions
- Command syntax: /github-swarm [args]
...
[commit|confident] <promise>GITHUB_SWARM_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]