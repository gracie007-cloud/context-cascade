...
### Trigger Conditions
- Command syntax: /vercel-deploy [args]
...
[commit|confident] <promise>VERCEL_DEPLOY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]