...
binding: skill:cloudflare-deploy
category: deployment
---
...
### Trigger Conditions
- Command syntax: /cloudflare-deploy [args]
...
[commit|confident] <promise>CLOUDFLARE_DEPLOY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]