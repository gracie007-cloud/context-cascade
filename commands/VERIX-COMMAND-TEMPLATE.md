...
### Purpose
- Primary action: {what this command does}

### Trigger Conditions
- Command syntax: /VERIX-COMMAND-TEMPLATE [args]
...
### Example Invocation
- /VERIX-COMMAND-TEMPLATE example
...
[commit|confident] <promise>{COMMAND_NAME}_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]