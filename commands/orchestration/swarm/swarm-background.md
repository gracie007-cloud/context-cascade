...
binding: skill:swarm-background
category: delivery
---
...
### Trigger Conditions
- Command syntax: /swarm-background [args]
...
[commit|confident] <promise>SWARM_BACKGROUND_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]