...
### Trigger Conditions
- Command syntax: /swarm-analysis [args]
...
[commit|confident] <promise>SWARM_ANALYSIS_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]