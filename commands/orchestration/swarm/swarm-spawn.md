...
### Trigger Conditions
- Command syntax: /swarm-spawn [args]
...
[commit|confident] <promise>SWARM_SPAWN_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]