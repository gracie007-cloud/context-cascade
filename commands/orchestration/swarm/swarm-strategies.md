...
binding: skill:swarm-strategies
category: delivery
---
...
### Trigger Conditions
- Command syntax: /swarm-strategies [args]
...
[commit|confident] <promise>SWARM_STRATEGIES_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]