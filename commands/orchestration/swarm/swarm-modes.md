...
### Trigger Conditions
- Command syntax: /swarm-modes [args]
...
[commit|confident] <promise>SWARM_MODES_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]