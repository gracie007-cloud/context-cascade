...
### Trigger Conditions
- Command syntax: /swarm-status [args]
...
[commit|confident] <promise>SWARM_STATUS_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]