...
### Trigger Conditions
- Command syntax: /meta-loop-rollback [args]
...
[commit|confident] <promise>META_LOOP_ROLLBACK_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]