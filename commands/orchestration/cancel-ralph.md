...
### Trigger Conditions
- Command syntax: /cancel-ralph [args]
...
[commit|confident] <promise>CANCEL_RALPH_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]