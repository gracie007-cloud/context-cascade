...
### Trigger Conditions
- Command syntax: /agent-spawn [args]
...
[commit|confident] <promise>AGENT_SPAWN_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]