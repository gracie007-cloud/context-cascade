...
binding: skill:task-orchestrate
category: delivery
---
...
### Trigger Conditions
- Command syntax: /task-orchestrate [args]
...
[commit|confident] <promise>TASK_ORCHESTRATE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]