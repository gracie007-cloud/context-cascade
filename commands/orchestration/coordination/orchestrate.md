...
### Trigger Conditions
- Command syntax: /orchestrate [args]
...
[commit|confident] <promise>ORCHESTRATE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]