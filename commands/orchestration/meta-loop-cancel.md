...
binding: skill:meta-loop-cancel
category: delivery
---
...
### Trigger Conditions
- Command syntax: /meta-loop-cancel [args]
...
[commit|confident] <promise>META_LOOP_CANCEL_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]