...
binding: skill:hive-mind-memory
category: delivery
---
...
### Trigger Conditions
- Command syntax: /hive-mind-memory [args]
...
[commit|confident] <promise>HIVE_MIND_MEMORY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]