...
### Trigger Conditions
- Command syntax: /hive-mind-stop [args]
...
[commit|confident] <promise>HIVE_MIND_STOP_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]