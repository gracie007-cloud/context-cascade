...
binding: skill:hive-mind-status
category: delivery
---
...
### Trigger Conditions
- Command syntax: /hive-mind-status [args]
...
[commit|confident] <promise>HIVE_MIND_STATUS_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]