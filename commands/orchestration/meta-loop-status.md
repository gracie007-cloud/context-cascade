...
binding: skill:meta-loop-status
category: delivery
---
...
### Trigger Conditions
- Command syntax: /meta-loop-status [args]
...
[commit|confident] <promise>META_LOOP_STATUS_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]