...
### Trigger Conditions
- Command syntax: /meta-loop-foundry [args]
...
[commit|confident] <promise>META_LOOP_FOUNDRY_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]