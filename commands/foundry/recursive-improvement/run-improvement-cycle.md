...
### Trigger Conditions
- Command syntax: /run-improvement-cycle [args]
...
[commit|confident] <promise>RUN_IMPROVEMENT_CYCLE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]