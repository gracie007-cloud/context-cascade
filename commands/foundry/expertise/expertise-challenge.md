...
### Purpose
- Primary action: Domain to challenge

### Trigger Conditions
- Command syntax: /expertise-challenge [args]
...
[commit|confident] <promise>EXPERTISE_CHALLENGE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]