...
### Purpose
- Primary action: Domain to validate

### Trigger Conditions
- Command syntax: /expertise-validate [args]
...
[commit|confident] <promise>EXPERTISE_VALIDATE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]