...
### Trigger Conditions
- Command syntax: /expertise-create [args]
...
[commit|confident] <promise>EXPERTISE_CREATE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]