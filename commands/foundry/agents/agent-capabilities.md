...
binding: skill:agent-capabilities
category: delivery
---
...
### Trigger Conditions
- Command syntax: /agent-capabilities [args]
...
[commit|confident] <promise>AGENT_CAPABILITIES_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]