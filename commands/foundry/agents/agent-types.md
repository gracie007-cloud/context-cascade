...
### Trigger Conditions
- Command syntax: /agent-types [args]
...
[commit|confident] <promise>AGENT_TYPES_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]