...
### Trigger Conditions
- Command syntax: /agent-spawning [args]
...
[commit|confident] <promise>AGENT_SPAWNING_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]