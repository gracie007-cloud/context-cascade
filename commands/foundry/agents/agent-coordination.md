...
binding: skill:agent-coordination
category: delivery
---
...
### Trigger Conditions
- Command syntax: /agent-coordination [args]
...
[commit|confident] <promise>AGENT_COORDINATION_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]