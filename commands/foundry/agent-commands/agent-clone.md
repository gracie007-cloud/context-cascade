...
x-version: 2.0.0
x-category: agent-management
x-vcl-compliance: v3.1.1
binding: skill:agent-clone
...
### Trigger Conditions
- Command syntax: /agent-clone [args]
...
[commit|confident] <promise>AGENT_CLONE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]