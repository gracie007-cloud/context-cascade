...
### Trigger Conditions
- Command syntax: /agent-health-check [args]
...
[commit|confident] <promise>AGENT_HEALTH_CHECK_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]