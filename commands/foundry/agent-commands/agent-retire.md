...
### Trigger Conditions
- Command syntax: /agent-retire [args]
...
[commit|confident] <promise>AGENT_RETIRE_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]