...
### Purpose
- Primary action: Problem description

### Trigger Conditions
- Command syntax: /agent-rca [args]
...
[commit|confident] <promise>AGENT_RCA_VERILINGUA_VERIX_COMPLIANT</promise> [conf:0.88] [state:confirmed]