...
x-origin-path: research/emerging/edge/edge-computing-specialist.md
---
---
...
### Purpose
- Mission: edge-computing-specialist agent for agent tasks
- Category: research; source file: research/emerging/edge/edge-computing-specialist.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require edge-computing-specialist responsibilities or align with the research domain.
...
[commit|confident] &lt;promise&gt;EDGE_COMPUTING_SPECIALIST_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
