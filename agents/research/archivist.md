---
name: archivist
description: archivist agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: research/archivist.md
---
---
...
### Purpose
- Mission: archivist agent for agent tasks
- Category: research; source file: research/archivist.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require archivist responsibilities or align with the research domain.
...
[commit|confident] &lt;promise&gt;ARCHIVIST_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
