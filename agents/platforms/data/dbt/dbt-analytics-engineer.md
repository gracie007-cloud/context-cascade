...
x-origin-path: platforms/data/dbt/dbt-analytics-engineer.md
---
---
...
### Purpose
- Mission: dbt-analytics-engineer agent for agent tasks
- Category: platforms; source file: platforms/data/dbt/dbt-analytics-engineer.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require dbt-analytics-engineer responsibilities or align with the platforms domain.
...
[commit|confident] &lt;promise&gt;DBT_ANALYTICS_ENGINEER_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
