...
x-origin-path: platforms/data/governance/data-governance-agent.md
---
---
...
### Purpose
- Mission: data-governance-agent agent for agent tasks
- Category: platforms; source file: platforms/data/governance/data-governance-agent.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require data-governance-agent responsibilities or align with the platforms domain.
...
[commit|confident] &lt;promise&gt;DATA_GOVERNANCE_AGENT_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
