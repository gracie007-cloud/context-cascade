...
x-origin-path: platforms/data/kafka/kafka-streaming-agent.md
---
---
...
### Purpose
- Mission: kafka-streaming-agent agent for agent tasks
- Category: platforms; source file: platforms/data/kafka/kafka-streaming-agent.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require kafka-streaming-agent responsibilities or align with the platforms domain.
...
[commit|confident] &lt;promise&gt;KAFKA_STREAMING_AGENT_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
