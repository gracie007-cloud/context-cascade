...
description: codex-reasoning-agent agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: platforms/flow-nexus/codex-reasoning-agent.md
---
---
...
### Purpose
- Mission: codex-reasoning-agent agent for agent tasks
- Category: platforms; source file: platforms/flow-nexus/codex-reasoning-agent.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require codex-reasoning-agent responsibilities or align with the platforms domain.
...
[commit|confident] &lt;promise&gt;CODEX_REASONING_AGENT_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
