...
description: multi-model-orchestrator agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: platforms/flow-nexus/multi-model-orchestrator.md
---
---
...
### Purpose
- Mission: multi-model-orchestrator agent for agent tasks
- Category: platforms; source file: platforms/flow-nexus/multi-model-orchestrator.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require multi-model-orchestrator responsibilities or align with the platforms domain.
...
[commit|confident] &lt;promise&gt;MULTI_MODEL_ORCHESTRATOR_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
