...
description: mlops-deployment-agent agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: platforms/ai-ml/mlops/mlops-deployment-agent.md
---
---
...
### Purpose
- Mission: mlops-deployment-agent agent for agent tasks
- Category: platforms; source file: platforms/ai-ml/mlops/mlops-deployment-agent.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require mlops-deployment-agent responsibilities or align with the platforms domain.
...
[commit|confident] &lt;promise&gt;MLOPS_DEPLOYMENT_AGENT_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
