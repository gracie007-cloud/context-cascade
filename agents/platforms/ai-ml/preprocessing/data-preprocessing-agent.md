...
x-origin-path: platforms/ai-ml/preprocessing/data-preprocessing-agent.md
---
---
...
### Purpose
- Mission: data-preprocessing-agent agent for agent tasks
- Category: platforms; source file: platforms/ai-ml/preprocessing/data-preprocessing-agent.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require data-preprocessing-agent responsibilities or align with the platforms domain.
...
[commit|confident] &lt;promise&gt;DATA_PREPROCESSING_AGENT_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
