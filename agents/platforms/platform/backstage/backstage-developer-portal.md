...
x-origin-path: platforms/platform/backstage/backstage-developer-portal.md
---
---
...
### Purpose
- Mission: backstage-developer-portal agent for agent tasks
- Category: platforms; source file: platforms/platform/backstage/backstage-developer-portal.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require backstage-developer-portal responsibilities or align with the platforms domain.
...
[commit|confident] &lt;promise&gt;BACKSTAGE_DEVELOPER_PORTAL_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
