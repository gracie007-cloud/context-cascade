...
x-origin-path: operations/infrastructure/gcp/gcp-specialist.md
---
---
...
### Purpose
- Mission: gcp-specialist agent for agent tasks
- Category: operations; source file: operations/infrastructure/gcp/gcp-specialist.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require gcp-specialist responsibilities or align with the operations domain.
...
[commit|confident] &lt;promise&gt;GCP_SPECIALIST_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
