...
x-origin-path: operations/infrastructure/ansible/ansible-automation-specialist.md
---
---
...
### Purpose
- Mission: ansible-automation-specialist agent for agent tasks
- Category: operations; source file: operations/infrastructure/ansible/ansible-automation-specialist.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require ansible-automation-specialist responsibilities or align with the operations domain.
