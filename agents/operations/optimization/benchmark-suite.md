...
description: benchmark-suite agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: operations/optimization/benchmark-suite.md
---
---
...
### Purpose
- Mission: benchmark-suite agent for agent tasks
- Category: operations; source file: operations/optimization/benchmark-suite.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require benchmark-suite responsibilities or align with the operations domain.
...
[commit|confident] &lt;promise&gt;BENCHMARK_SUITE_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
