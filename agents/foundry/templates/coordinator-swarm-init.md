...
description: coordinator-swarm-init agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: foundry/templates/coordinator-swarm-init.md
---
---
...
### Purpose
- Mission: coordinator-swarm-init agent for agent tasks
- Category: foundry; source file: foundry/templates/coordinator-swarm-init.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require coordinator-swarm-init responsibilities or align with the foundry domain.
...
[commit|confident] &lt;promise&gt;COORDINATOR_SWARM_INIT_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
