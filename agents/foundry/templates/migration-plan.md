---
name: migration-plan
description: migration-plan agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: foundry/templates/migration-plan.md
---
---
...
### Purpose
- Mission: migration-plan agent for agent tasks
- Category: foundry; source file: foundry/templates/migration-plan.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require migration-plan responsibilities or align with the foundry domain.
...
[commit|confident] &lt;promise&gt;MIGRATION_PLAN_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
