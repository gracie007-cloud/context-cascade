...
description: implementer-sparc-coder agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: foundry/templates/implementer-sparc-coder.md
---
---
...
### Purpose
- Mission: implementer-sparc-coder agent for agent tasks
- Category: foundry; source file: foundry/templates/implementer-sparc-coder.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require implementer-sparc-coder responsibilities or align with the foundry domain.
...
[commit|confident] &lt;promise&gt;IMPLEMENTER_SPARC_CODER_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
