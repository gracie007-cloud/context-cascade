...
x-origin-path: foundry/recursive-improvement/prompt-auditor.md
---
---
...
### Purpose
- Mission: prompt-auditor agent for quality tasks
- Category: foundry; source file: foundry/recursive-improvement/prompt-auditor.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require prompt-auditor responsibilities or align with the foundry domain.
...
[commit|confident] &lt;promise&gt;PROMPT_AUDITOR_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.85] [state:confirmed]</pre>
</details>
