...
x-origin-path: orchestration/swarm/hierarchical-coordinator.md
---
---
...
### Purpose
- Mission: hierarchical-coordinator agent for agent tasks
- Category: orchestration; source file: orchestration/swarm/hierarchical-coordinator.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require hierarchical-coordinator responsibilities or align with the orchestration domain.
...
[commit|confident] &lt;promise&gt;HIERARCHICAL_COORDINATOR_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
