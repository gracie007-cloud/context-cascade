...
x-origin-path: orchestration/swarm/consensus-validator.md
---
---
...
### Purpose
- Mission: consensus-validator agent for agent tasks
- Category: orchestration; source file: orchestration/swarm/consensus-validator.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require consensus-validator responsibilities or align with the orchestration domain.
...
[commit|confident] &lt;promise&gt;CONSENSUS_VALIDATOR_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
