...
x-origin-path: orchestration/consensus/byzantine-coordinator.md
---
---
...
### Purpose
- Mission: byzantine-coordinator agent for agent tasks
- Category: orchestration; source file: orchestration/consensus/byzantine-coordinator.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require byzantine-coordinator responsibilities or align with the orchestration domain.
...
[commit|confident] &lt;promise&gt;BYZANTINE_COORDINATOR_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
