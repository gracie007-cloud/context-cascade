...
description: gossip-coordinator agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: orchestration/consensus/gossip-coordinator.md
---
---
...
### Purpose
- Mission: gossip-coordinator agent for agent tasks
- Category: orchestration; source file: orchestration/consensus/gossip-coordinator.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require gossip-coordinator responsibilities or align with the orchestration domain.
...
[commit|confident] &lt;promise&gt;GOSSIP_COORDINATOR_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
