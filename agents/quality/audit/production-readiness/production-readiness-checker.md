...
x-origin-path: quality/audit/production-readiness/production-readiness-checker.md
---
---
...
### Purpose
- Mission: production-readiness-checker agent for agent tasks
- Category: quality; source file: quality/audit/production-readiness/production-readiness-checker.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require production-readiness-checker responsibilities or align with the quality domain.
...
[commit|confident] &lt;promise&gt;PRODUCTION_READINESS_CHECKER_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
