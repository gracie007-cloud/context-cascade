---
name: code-analyzer
description: code-analyzer agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: quality/analysis/code-analyzer.md
---
---
...
### Purpose
- Mission: code-analyzer agent for agent tasks
- Category: quality; source file: quality/analysis/code-analyzer.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require code-analyzer responsibilities or align with the quality domain.
...
[commit|confident] &lt;promise&gt;CODE_ANALYZER_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
