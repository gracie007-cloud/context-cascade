...
description: root-cause-analyzer agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: quality/analysis/root-cause-analyzer.md
---
---
...
### Purpose
- Mission: root-cause-analyzer agent for agent tasks
- Category: quality; source file: quality/analysis/root-cause-analyzer.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require root-cause-analyzer responsibilities or align with the quality domain.
...
[commit|confident] &lt;promise&gt;ROOT_CAUSE_ANALYZER_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
