...
### Purpose
- Mission: visual-regression-agent agent for agent tasks
- Category: quality; source file: quality/testing/visual-regression-agent.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require visual-regression-agent responsibilities or align with the quality domain.
