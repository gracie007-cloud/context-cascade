...
### Purpose
- Mission: contract-testing-agent agent for agent tasks
- Category: quality; source file: quality/testing/contract-testing-agent.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require contract-testing-agent responsibilities or align with the quality domain.
