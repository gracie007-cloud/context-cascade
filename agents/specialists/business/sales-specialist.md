...
description: sales-specialist agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: specialists/business/sales-specialist.md
---
---
...
### Purpose
- Mission: sales-specialist agent for agent tasks
- Category: specialists; source file: specialists/business/sales-specialist.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require sales-specialist responsibilities or align with the specialists domain.
...
[commit|confident] &lt;promise&gt;SALES_SPECIALIST_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
