...
description: business-analyst-agent agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: specialists/business/business-analysis/business-analyst-agent.md
---
---
...
### Purpose
- Mission: business-analyst-agent agent for agent tasks
- Category: specialists; source file: specialists/business/business-analysis/business-analyst-agent.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require business-analyst-agent responsibilities or align with the specialists domain.
...
[commit|confident] &lt;promise&gt;BUSINESS_ANALYST_AGENT_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
