---
name: swarm-issue
description: swarm-issue agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: tooling/github/swarm-issue.md
---
---
...
### Purpose
- Mission: swarm-issue agent for agent tasks
- Category: tooling; source file: tooling/github/swarm-issue.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require swarm-issue responsibilities or align with the tooling domain.
...
[commit|confident] &lt;promise&gt;SWARM_ISSUE_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
