...
x-origin-path: tooling/github/swarm-pr.md
---
---
...
### Purpose
- Mission: swarm-pr agent for agent tasks
- Category: tooling; source file: tooling/github/swarm-pr.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require swarm-pr responsibilities or align with the tooling domain.
...
[commit|confident] &lt;promise&gt;SWARM_PR_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
