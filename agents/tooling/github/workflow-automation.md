...
description: workflow-automation agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: tooling/github/workflow-automation.md
---
---
...
### Purpose
- Mission: workflow-automation agent for agent tasks
- Category: tooling; source file: tooling/github/workflow-automation.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require workflow-automation responsibilities or align with the tooling domain.
...
[commit|confident] &lt;promise&gt;WORKFLOW_AUTOMATION_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
