---
name: pr-manager
description: pr-manager agent for agent tasks
allowed-tools:
- Read
- Write
- Edit
...
x-origin-path: tooling/github/pr-manager.md
---
---
...
### Purpose
- Mission: pr-manager agent for agent tasks
- Category: tooling; source file: tooling/github/pr-manager.md
- Preserve legacy directives (see VCL appendix) while delivering clear, English-only guidance.

### Trigger Conditions
- Activate when tasks require pr-manager responsibilities or align with the tooling domain.
...
[commit|confident] &lt;promise&gt;PR_MANAGER_VERILINGUA_VERIX_COMPLIANT&lt;/promise&gt; [ground:self-validation] [conf:0.99] [state:confirmed]</pre>
</details>
