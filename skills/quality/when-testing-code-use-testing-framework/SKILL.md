/*============================================================================*/
/* WHEN-TESTING-CODE-USE-TESTING-FRAMEWORK SKILL :: VERILINGUA x VERIX EDITION                      */
/*============================================================================*/
...
version: 1.0.0
description: |
  [assert|neutral] - **Skill ID**: when-testing-code-use-testing-framework [ground:given] [conf:0.95] [state:confirmed]
category: quality
tags:
- quality
- testing
...
cognitive_frame:
  primary: evidential
  goal_analysis:
    first_order: "Execute when-testing-code-use-testing-framework workflow"
