/*============================================================================*/
/* WHEN-ORCHESTRATING-SWARM-USE-SWARM-ORCHESTRATION SKILL :: VERILINGUA x VERIX EDITION                      */
/*============================================================================*/
...
version: 1.0.0
description: |
  [assert|neutral] Complex multi-agent swarm orchestration with task decomposition, distributed execution, and result synthesis [ground:given] [conf:0.95] [state:confirmed]
category: workflow
tags:
- swarm
- orchestration
...
cognitive_frame:
  primary: evidential
  goal_analysis:
    first_order: "Execute when-orchestrating-swarm-use-swarm-orchestration workflow"
